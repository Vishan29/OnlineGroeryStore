...
if(isset($_POST['update_order'])){
   ...
   $update_delivery = filter_var($update_delivery, FILTER_SANITIZE_STRING);
   $update_orders = $conn->prepare("UPDATE `orders` SET delivery_status = ?,payment_status = ? WHERE id = ?");
   $update_orders->execute([$update_delivery,$update_delivery,$order_id]);
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <form action="" method="POST">
            ...
            <select name="update_delivery" class="drop-down">
